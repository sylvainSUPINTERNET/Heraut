...
public interface AnnouncesRepository extends JpaRepository<Announces, Long> {
    ...
    @Query(value = "SELECT * FROM announces as ann JOIN announces_services as anns on ann.id = anns.announces_id JOIN announces_animals_type as aat on ann.id = aat.announces_id WHERE anns.services_id = :services AND aat.animals_type_id = :animals AND ann.dept = :department", nativeQuery = true)
    ...
    // animals + dept
    @Query(value = "SELECT * FROM announces as ann JOIN announces_animals_type as aat on ann.id = aat.announces_id WHERE aat.animals_type_id = :animals AND ann.dept = :department", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM announces as ann JOIN announces_services as anns on ann.id = anns.announces_id WHERE anns.services_id = :services AND ann.dept = :department", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM announces as ann JOIN announces_services as anns on ann.id = anns.announces_id JOIN announces_animals_type as aat on ann.id = aat.announces_id WHERE anns.services_id = :services AND aat.animals_type_id = :animals", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM announces as ann JOIN announces_services as anns on ann.id = anns.announces_id WHERE anns.services_id = :services", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM announces as ann JOIN announces_animals_type as aat on ann.id = aat.announces_id WHERE aat.animals_type_id = :animals", nativeQuery = true)
    Page<Announces> findAllByQueryAnimalTypeAndPopulate(@Param("animals") Long animals,Pageable pageable);

    // dept
    @Query("SELECT a FROM Announces a WHERE a.dept = :department ")
